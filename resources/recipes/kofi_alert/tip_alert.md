...
This overlay fires on a Ko-fi donation once Ko-fi is connected. The product install writes the trigger for you. Ko-fi also sends subscriptions, shop orders and commissions; the alert's Triggers tab switches those on for the same alert.
