...
Who donated and how much, with their message if they left one. Plays a sound, speaks the line after the sound, and posts it to chat through the Overlabels bot.
...
This overlay fires on a Fourthwall donation once Fourthwall is connected. The product install writes the trigger for you.
