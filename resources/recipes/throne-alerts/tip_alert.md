...
Who sent a gift and what it was worth, with their message if they left one. Plays a sound, speaks the line after the sound, and posts it to chat through the Overlabels bot.
...
<div class="alert donation-alert">
  <p>[[[event.from_name]]] sent [[[event.formatted_amount]]]</p>
  [[[if:event.message]]]
...
- Speaks via text to speech after a 3000ms delay: `[[[event.from_name]]] sent [[[event.formatted_amount]]]`
- Posts to Twitch chat via the @overlabels bot: `[[[event.from_name]]] sent [[[event.formatted_amount]]]`

## Requirements

This overlay fires on a Throne gift or contribution once Throne is connected. The product install writes the trigger for you.
