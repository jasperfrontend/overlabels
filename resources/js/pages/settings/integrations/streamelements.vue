          ...
          <div class="space-y-2">
            ...
            <template v-if="donationsSeedSet">
              <p class="text-muted-foreground text-sm">
                ...
                Your <code
                class="rounded bg-black/10 px-1 dark:bg-white/10">[[[c:streamelements:total_received]]]</code>
            ...
            <template v-else>
              <p class="text-muted-foreground text-sm">
                Had StreamElements donations before joining? Set the total you already raised so your overlay doesn't
                begin at zero. Decimals are fine, in whichever notation you write money. All your
