    ...
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                ...
                <!-- Connected state -->
                <template v-if="integration.connected">
                    <div class="rounded-sm border border-border bg-sidebar-accent p-4 mb-6 space-y-2 text-sm text-muted-foreground">
                    ...
                    <div class="space-y-2">
                        ...
                        <template v-if="donationsSeedSet">
                            <p class="text-muted-foreground text-sm">
                                ...
                                Your <code class="rounded bg-black/10 px-1 dark:bg-white/10">[[[c:streamlabs:donations_received]]]</code>
