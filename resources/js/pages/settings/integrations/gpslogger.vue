      ...
      <div class="space-y-6">
        ...
        <div v-if="!integration.connected"
          ...
          <ol class="list-decimal pl-4 space-y-1">
            ...
            <li>Install <a href="https://play.google.com/store/apps/details?id=com.mendhak.gpslogger" target="_blank"
                           rel="noopener" class="text-violet-400 hover:underline font-medium">GPSLogger</a> on your
              Android phone (free, open source).
            </li>
            <li>In the app, set up <strong>Log to custom URL</strong> with the webhook URL and token you chose here.
            </li>
