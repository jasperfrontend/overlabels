    ...
    <div class="min-h-screen bg-background">
      <div class="mx-auto max-w-4xl p-6">
        <div class="mb-8">
          ...
          <p class="text-lg text-foreground">See your <a href="/tags" class="text-violet-400 hover:underline">static Template Tags</a> you can use for your account level.</p>
        </div>
