    ...
    <div class="flex h-full flex-1 flex-col gap-4 p-4">
      ...
      <section v-if="!showWelcomeAlert" class="mb-6">
        <button 
          ...
          class="flex items-center gap-2 text-sm text-muted-foreground hover:text-yellow-400 transition-colors group"
        >
          <RotateCcw class="h-4 w-4 group-hover:text-yellow-500" />
