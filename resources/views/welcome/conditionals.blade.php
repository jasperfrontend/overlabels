<section id="conditionals" class="scroll-mt-16 border-b border-sidebar-accent py-24">
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-5xl">
      <span class="inline-flex items-center border-transparent bg-accent text-foreground font-semibold transition-colors mb-4 px-3 py-1 font-mono text-xs hover:bg-background-accent">Conditional Rendering</span>
      ...
      <p class="mb-12 max-w-2xl text-lg text-foreground">
        ...
        to 10 levels deep.
        <a href="/help/conditionals" class="ml-1 text-sky-500 hover:underline cursor-pointer">Full syntax reference →</a>
      </p>
        ...
        <div>
          ...
          <div class="divide-y divide-sidebar-accent overflow-hidden rounded-sm bg-card/50">
            @foreach ([
              ...
              <div class="flex items-center gap-4 bg-card/50 px-4 py-2.5">
      ...
      <div class="overflow-hidden rounded-sm max-w-3xl hover:max-w-full transition-all">
        ...
        <div class="overflow-x-auto bg-card p-5 font-mono text-sm leading-7">
          ...
          <div>
            &nbsp;&nbsp;<span class="text-zinc-500">&lt;p&gt;</span><span class="text-foreground">Welcome to the stream</span><span class="text-zinc-500">&lt;/p&gt;</span>
          </div>
          <div><span class="text-sky-600 dark:text-sky-400">[[[elseif:channel_language = es]]]</span></div>
          <div>
            &nbsp;&nbsp;<span class="text-zinc-500">&lt;p&gt;</span><span class="text-foreground">Bienvenidos al stream</span><span class="text-zinc-500">&lt;/p&gt;</span>
          </div>
          <div><span class="text-sky-600 dark:text-sky-400">[[[else]]]</span></div>
          <div>
            &nbsp;&nbsp;<span class="text-zinc-500">&lt;p&gt;</span><span class="text-foreground">Welcome</span><span class="text-zinc-500">&lt;/p&gt;</span>
          </div>
          <div><span class="text-sky-600 dark:text-sky-400">[[[endif]]]</span></div>
          <div class="mt-3"></div>
          <div><span class="text-sky-600 dark:text-sky-400">[[[if:followers_total &gt;= 10000]]]</span></div>
          <div>
            &nbsp;&nbsp;<span class="text-zinc-500">&lt;div class=</span><span class="text-emerald-600 dark:text-emerald-400">"tenk-badge"</span><span class="text-zinc-500">&gt;</span><span class="text-foreground">10K club</span><span class="text-zinc-500">&lt;/div&gt;</span>
          </div>
          <div><span class="text-sky-600 dark:text-sky-400">[[[endif]]]</span></div>
        </div>
      </div>
