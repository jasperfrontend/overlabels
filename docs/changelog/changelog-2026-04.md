...
- Frontend `live.vue` types updated to match (DoorPayload.is_exit, BlockerPayload, WorldPayload.blockers, dropped HidingSpotPayload.open_sides). No visual rendering for blockers yet - that lands with the room-5 polish pass.
